...
import { seriesApi, userApi } from "../lib/api";
  ...
  useEffect(() => {
    ...
    async function loadSeries() {
      ...
      try {
        ...
        const [seriesData, favoriteData] = await Promise.all([
          seriesApi.getDetails(id),
        ...
        if (favoriteData.success) {
          ...
          const exists = favoriteData.items.some(
  ...
  const toggleFavorite = async () => {
    ...
    try {
      ...
      if (favorite) {
        ...
        await userApi.addFavorite(id, "series");
      ...
      >
        ...
        <div>
          ...
          >
            ...
            <button
              onClick={() => navigate(`/watch/series/${movie.id}`)}
              style={{
